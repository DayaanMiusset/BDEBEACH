INSERT INTO `beach`.`usuario` (`nombre`, `apellido`, `correo`, `contrasena`, `telefono`, `callenumero`, `colonia`, `estado`, `CP`) VALUES ('Aarón', 'Rosas', 'aaronrosas0409@gmail.com', 'Colorin1', '5534655767', 'Calle Broca', 'Gaulle', 'CDMX', '46501');
INSERT INTO `beach`.`usuario` (`nombre`, `apellido`, `correo`, `contrasena`, `telefono`, `callenumero`, `colonia`, `estado`, `CP`) VALUES ('DayaanM', 'Sierra', 'dayaan.sierrajob@gmail.com', 'Unacontraseña123', '3323438230', 'Calle #123', 'Bonita', 'Jalisco', '99999');
INSERT INTO `beach`.`usuario` (`nombre`, `apellido`, `correo`, `contrasena`, `telefono`, `callenumero`, `colonia`, `estado`, `CP`) VALUES ('Sofia', 'Suarez', 'luisasofia.cdhcm@gmail.com', 'Sofia12345', '5512345678', 'Cine #22', 'Polis', 'CDMX', '90909');
INSERT INTO `beach`.`usuario` (`nombre`, `apellido`, `correo`, `contrasena`, `telefono`, `callenumero`, `colonia`, `estado`, `CP`) VALUES ('Arely', 'Aparicio', 'arely.aparicio@gmail.com', 'Hola1234', '5512398745', 'Calle Poniente', 'Verde', 'CDMX', '55600');
INSERT INTO `beach`.`usuario` (`nombre`, `apellido`, `correo`, `contrasena`, `telefono`, `callenumero`, `colonia`, `estado`, `CP`) VALUES ('Asael', 'Rivera', 'riveracontrerasasael@gmail.com', 'Pa$$w0rd', '7131025427', 'Calle# 13', 'Lomas', 'CDMX', '55700');
